	...
	func publishedPosts() -> [BlogPost] {
		[
			...
			BlogPost(title: "The Maldives",
					 ...
					 excerpt: "Possimus est labore recusandae asperiores fuga sequi",
					 date: "2014",
					 category: "Islands",
			...
			BlogPost(title: "Sri Lanka",
					 ...
					 excerpt: "Ratione est quo nem",
					 date: "2014",
					 category: "Islands",
					 content: "Deserunt nulla culpa quibusdam. Ducimus delectus ea ipsa quisquam aut in dolor placeat dolore. aspernatur ea a accusantium quia deleniti quia. Error aliquam harum earum. Quos dignissimos dolores ratione illo. Dolores velit sunt sed quas quis itaque sit omnis. Molestias explicabo aut eum amet blanditiis quia similique soluta."),
		]
	}
}
